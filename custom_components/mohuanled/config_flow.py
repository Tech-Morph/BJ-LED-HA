"""Config flow for MohuanLED (BJ_LED) lights.
...
class MohuanLedConfigFlow(ConfigFlow, domain=DOMAIN):
    """Handle a config flow for MohuanLED (BJ_LED) lights."""
    ...
    async def async_step_user(
        ...
        return self.async_show_form(
            ...
            description_placeholders={
                ...
                "address manually (e.g. FF:10:10:85:6C:1B)."
            },
        )
